...
# EXPLANATION:
# Takes an array of numbers (arr).
# It iterates through the array and checks for the first element that is not consecutive to its predecessor.
# If found, it returns that element; otherwise, it returns None.
