...
# The function uses a dictionary (languages) to store the greetings for each
# language and uses the get method to retrieve the greeting for the specified language,
# defaulting to English if the language is not found.
def greet(language):
    language = {
        'english': 'Welcome',
        'czech': 'Vitejte',
