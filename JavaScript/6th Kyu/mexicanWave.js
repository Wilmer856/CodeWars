...
// packed stadium when successive groups of spectators briefly stand, yell, and raise their arms. 
...
function wave(str){
    ...
    for(let i = 0; i < str.length; i++) {
      ...
      let wave = str;
      arr.push(wave.slice(0, i) + wave.charAt(i).toUpperCase() + wave.slice(i + 1));
    }
    return arr;
}